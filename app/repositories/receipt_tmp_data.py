...
class ReceiptTmpDataRepository:
    @classmethod
    async def add_job_id_to_status_set(cls, status ,job_id) -> None:
    ...
    @classmethod
    async def remove_job_id_from_status_set(cls, status, job_id) -> None:
    ...
    @classmethod
    async def get_job_ids_by_status(cls, status) -> List[str]:
