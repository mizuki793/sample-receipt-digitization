...
- [技術スタック](##技術スタック)
- [ローカル起動（Docker Compose）](##ローカル起動手順)
- [ディレクトリ構成](##ディレクトリ構成)
- [補足](##補足)
...
---
## 動作デモ
- OCR関連の挙動での読み込みが時間が長い関係上、動画を1.5倍速にしています
...
---
## ローカル起動手順
- 開発を実施する場合は以下のドキュメントを確認してください 
  - [開発向けドキュメント](./docs/DEV_README.md)
